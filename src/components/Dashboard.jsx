    ...
    <div className="fade-in-view">
      ...
      <div className="card border-0 bg-success text-white p-4 mb-4 rounded-3 shadow-sm position-relative overflow-hidden">
        <div className="position-relative z-1" style={{ zIndex: 2 }}>
          <h2 className="display-6 fw-bold font-heading mb-1">Â¡Buen dÃ­a, Carlos!</h2>
          <p className="mb-0 opacity-90 fs-5">
            Planta operando bajo estÃ¡ndares HACCP. Tienes <strong>{abiertasCapa}</strong> Acciones Correctivas (CAPA) abiertas que requieren verificaciÃ³n.
          </p>
        </div>
      ...
      <div className="row g-4 mb-4">
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card OCA-card p-3 h-100 border-0">
            <div className="d-flex align-items-center mb-3">
              ...
              <div>
                <h6 className="text-muted mb-0 small uppercase fw-bold">BitÃ¡cora Saneamiento</h6>
          ...
          <div className="card OCA-card p-3 h-100 border-0">
            ...
            <div className="text-secondary small mt-auto">
              {alertasVariables > 0 ? (
                ...
                <span className="text-success fw-bold"><i className="bi bi-shield-check me-1"></i>Puntos CrÃ­ticos seguros</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-6 col-lg-3">
          <div className="card OCA-card p-3 h-100 border-0">
            ...
            <div className="text-secondary small mt-auto">
              <span className="text-primary fw-bold">{vigentesBpm}</span> de {totalManipuladores} al dÃ­a.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-lg-8">
          <div className="card OCA-card p-4 border-0 h-100">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="card-title font-heading mb-0">Puntos de Control CrÃ­tico (PCC) - Tiempo Real</h4>
            ...
            <div className="row g-3">
              <div className="col-12 col-md-6">
                <div className="border rounded-3 p-3 bg-light bg-opacity-25">
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    <span className="fw-semibold small">CÃ¡mara RefrigeraciÃ³n 1</span>
                  ...
                  <div className="text-muted small mt-2">LÃ­mite crÃ­tico: &le; 8.0Â°C</div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-6">
                <div className="border rounded-3 p-3 bg-light bg-opacity-25">
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    <span className="fw-semibold small">Pasteurizador LÃ­nea B</span>
                    <span className="badge bg-success-subtle text-success">Normal</span>
                  </div>
                  <div className="d-flex align-items-baseline">
                  ...
                  <div className="text-muted small mt-2">LÃ­mite crÃ­tico: &ge; 72.0Â°C (15s)</div>
                </div>
              </div>
              ...
              <div className="col-12 col-md-6">
                <div className="border rounded-3 p-3 bg-light bg-opacity-25">
                  <div className="d-flex justify-content-between align-items-center mb-2">
                    <span className="fw-semibold small">CÃ¡mara CongelaciÃ³n 2</span>
                    <span className="badge bg-success-subtle text-success">Normal</span>
                  </div>
                  <div className="d-flex align-items-baseline">
                  ...
                  <div className="text-muted small mt-2">LÃ­mite crÃ­tico: &le; -15.0Â°C</div>
                </div>
              </div>
            </div>

            <div className="mt-4 pt-3 border-top">
              <h6 className="fw-semibold text-muted mb-3"><i className="bi bi-clock-history me-1"></i> Historial de Cumplimiento (Ãšltimas 5 horas)</h6>
        ...
        <div className="col-12 col-lg-4">
          <div className="card OCA-card p-4 border-0 h-100 d-flex flex-column">
            <h4 className="card-title font-heading mb-3">AuditorÃ­a y Acciones CAPA</h4>
            ...
            <div className="flex-grow-1 overflow-auto mb-3" style={{ maxHeight: '350px' }}>
              {abiertasCapa > 0 ? (
                ...
                <div className="text-center py-4 text-muted bg-light bg-opacity-25 rounded-3 mb-4 border">
                  ...
                  <span className="small fw-semibold d-block text-dark">CAPA al dÃ­a</span>
                  <span className="small text-muted" style={{ fontSize: '11px' }}>No hay desviaciones abiertas pendientes de plan de acciÃ³n.</span>
                </div>
              )}

              <div>
                <h6 className="text-muted fw-bold small uppercase mb-2">Accesos Directos a AuditorÃ­a</h6>
                <div className="d-grid gap-2">
                  <button className="btn btn-light text-start btn-sm" onClick={() => onNavigate('alergenos-recall')}>
                    <i className="bi bi-shield-exclamation text-warning me-2"></i> Control de AlÃ©rgenos
                  </button>
                  <button className="btn btn-light text-start btn-sm" onClick={() => onNavigate('alergenos-recall')}>
            ...
            <div className="mt-auto pt-3 border-top">
              <h6 className="fw-semibold small mb-2 text-muted">AcciÃ³n Operativa RÃ¡pida</h6>
              <div className="d-grid gap-2">
                ...
                <button className="btn btn-outline-success text-start" onClick={() => onNavigate('variables')}>
                  <i className="bi bi-plus-circle-dotted me-2"></i> Registrar MediciÃ³n de Temp/pH
                </button>
              </div>
            </div>
          </div>
